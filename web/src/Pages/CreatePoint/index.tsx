...
const CreatePoint = () => {
    ...
    function handSelectedUF(event: ChangeEvent<HTMLSelectElement>){
        const uf = event.target.value;
        setSelectedUF(uf);
    }

    function handSelectedCity(event: ChangeEvent<HTMLSelectElement>){
    ...
    return (
        <div id="page-create-point">
            <header>
                <img src={logo} alt="Ecoleta" id="logo"></img>
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        <div className="field">
                            ...
                            <select name="uf" id="uf" value={selectedUF} onChange={handSelectedUF}>
                        ...
                        <div className="field">
                            ...
                            <select name="city" id="city" value={selectedCity} onChange={handSelectedCity}>
